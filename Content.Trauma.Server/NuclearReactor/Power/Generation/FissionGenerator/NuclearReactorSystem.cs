...
using Content.Trauma.Shared.NuclearReactor._FarHorizons.Materials.Systems;
...
namespace Content.Trauma.Server.NuclearReactor.Power.Generation.FissionGenerator;
